# HiveMind: Feature Deep-Dive & Architecture Audit

This document provides a technical index of every feature in the HiveMind platform, explaining **where** it is, **how** it works, and **why** it was implemented.

---

## ðŸ—ºï¸ 1. Core Map Visualization (`/map`)
...
### ðŸ—ºï¸ Infrastructure Visualization
...
### ðŸŒŠ Hydrology & Water Management
...
## ðŸš¨ 2. Safe Zone Intelligence (SZI) Engine
The SZI represents the "Intelligence" layer of the project.

### ðŸ§  Emergency Simulation (`SafeZoneOverlay.tsx`)
...
### ðŸ›£ï¸ OSRM Road-Following Routing
...
## ðŸ“ˆ 3. AI Predictive Analytics (`/analytics`)
This dashboard translates environmental data into economic risk.

### ðŸ§® Exponential Risk Cascade Model
-   **File**: `src/lib/prediction-model.ts`
-   **Logic**: `riskLevel(t) = baseline * exp(-Î» * flood_index * t)`.
...
## ðŸ› ï¸ Third Perspective: Optimizations & UI/UX

### ðŸ›ï¸ Architecture Optimization (Phase 1)
> [!IMPORTANT]
